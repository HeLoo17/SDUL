...
export const sampleVMs: VM[] = [
    ...
    { id: 5, vmid: "105", vmName: "backup-agent", status: "error", cpuUsage: 2.1, memoryUsage: 12.0, diskUsage: 95.5, uptime: 864000, node: "pve-02" },
    { id: 6, vmid: "201", vmName: "nginx-proxy-01", status: "running", cpuUsage: 5.4, memoryUsage: 18.2, diskUsage: 8.5, uptime: 2592000, node: "pve-01" },
    ...
    { id: 10, vmid: "404", vmName: "legacy-app-server", status: "running", cpuUsage: 92.4, memoryUsage: 96.1, diskUsage: 88.9, uptime: 31536000, node: "pve-01" }
];
